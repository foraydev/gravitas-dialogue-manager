...
exports.$JsonDecoderErrors = exports.JsonDecoder = void 0;
...
(function (JsonDecoder) {
        ...
        Decoder.prototype.mapError = function (fn) {
            ...
            return new Decoder(function (json) {
                ...
                if (result.isOk()) {
                    ...
                    return result_1.ok(fn(result.error));
                }
            });
        };
        /**
    ...
    JsonDecoder.emptyObject = new Decoder(function (json) {
        if (json !== null &&
            ...
            return result_1.err($JsonDecoderErrors.primitiveError(json, 'empty object'));
        }
    });
    /**
    ...
    function enumeration(enumObj, decoderName) {
        return new Decoder(function (json) {
            ...
            if (enumValue !== undefined) {
                return result_1.ok(enumValue);
            }
            return result_1.err($JsonDecoderErrors.enumValueError(decoderName, json));
        });
    }
        ...
        return new Decoder(function (json) {
            if (json instanceof Array) {
                ...
                if (json.length !== decoders.length) {
                    return result_1.err($JsonDecoderErrors.tupleLengthMismatchError(decoderName, json, decoders));
                }
                for (var i = 0; i < json.length; i++) {
