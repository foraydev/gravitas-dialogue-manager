...
describe('json-decoder', function () {
    ...
    describe('enumeration', function () {
        ...
        it('should decode when the value is in the enum', function () {
            expectOkWithValue(json_decoder_1.JsonDecoder.enumeration(IntEnum, 'IntEnum').decode(1), IntEnum.B /* 1 */);
            expectOkWithValue(json_decoder_1.JsonDecoder.enumeration(OddlyOrderedIntEnum, 'OddlyOrderedIntEnum').decode(-3), OddlyOrderedIntEnum.C /* -3 */);
            expectOkWithValue(json_decoder_1.JsonDecoder.enumeration(OddlyOrderedIntEnum, 'OddlyOrderedIntEnum').decode(0), OddlyOrderedIntEnum.D /* 0 */);
            expectOkWithValue(json_decoder_1.JsonDecoder.enumeration(HeterogeneousEnum, 'HeterogeneousEnum').decode(2), HeterogeneousEnum.Y /* 2 */);
            expectOkWithValue(json_decoder_1.JsonDecoder.enumeration(HeterogeneousEnum, 'HeterogeneousEnum').decode('foo'), HeterogeneousEnum.Z /* 'foo' */);
        });
        it('should fail when the value is not in the enum', function () {
            expectErrWithMsg(json_decoder_1.JsonDecoder.enumeration(IntEnum, 'IntEnum').decode(3), json_decoder_1.$JsonDecoderErrors.enumValueError('IntEnum', 3));
            expectErrWithMsg(json_decoder_1.JsonDecoder.enumeration(OddlyOrderedIntEnum, 'OddlyOrderedIntEnum').decode(3), json_decoder_1.$JsonDecoderErrors.enumValueError('OddlyOrderedIntEnum', 3));
            expectErrWithMsg(json_decoder_1.JsonDecoder.enumeration(HeterogeneousEnum, 'HeterogeneousEnum').decode(0), json_decoder_1.$JsonDecoderErrors.enumValueError('HeterogeneousEnum', 0));
        });
    });
    // failover
    ...
    describe('empty object', function () {
        it('should decode an empty object', function () {
            var json = {};
            expectOkWithValue(json_decoder_1.JsonDecoder.emptyObject.decode(json), {});
        });
        it('should fail to decode an object with properties', function () {
            var json = { a: 1 };
            expectErrWithMsg(json_decoder_1.JsonDecoder.emptyObject.decode(json), json_decoder_1.$JsonDecoderErrors.primitiveError(json, 'empty object'));
        });
        it('should fail to decode a non-object', function () {
            expectErrWithMsg(json_decoder_1.JsonDecoder.emptyObject.decode('hello'), json_decoder_1.$JsonDecoderErrors.primitiveError('hello', 'empty object'));
            expectErrWithMsg(json_decoder_1.JsonDecoder.emptyObject.decode(undefined), json_decoder_1.$JsonDecoderErrors.primitiveError(undefined, 'empty object'));
            expectErrWithMsg(json_decoder_1.JsonDecoder.emptyObject.decode(null), json_decoder_1.$JsonDecoderErrors.primitiveError(null, 'empty object'));
        });
    });
    // dictionary
    ...
    describe('tuple', function () {
        it('no decoders returns empty tuple', function () {
            expectOkWithValue(json_decoder_1.JsonDecoder.tuple([], '[]').decode([]), []);
        });
        it('should decode a [number, number] tuple', function () {
            var decoder = json_decoder_1.JsonDecoder.tuple([json_decoder_1.JsonDecoder.number, json_decoder_1.JsonDecoder.number], '[number, number]');
            expectOkWithValue(decoder.decode([2, 3]), [2, 3]);
        });
        it('should decode a [number, string, number[]] tuple', function () {
            var decoder = json_decoder_1.JsonDecoder.tuple([
                json_decoder_1.JsonDecoder.number,
                json_decoder_1.JsonDecoder.string,
                json_decoder_1.JsonDecoder.array(json_decoder_1.JsonDecoder.number, 'number[]')
        ...
        it('should decode throw a length mismatch error', function () {
            ...
            expectErrWithMsg(decoder.decode([2, 'foo', [3, 4, 5]]), json_decoder_1.$JsonDecoderErrors.tupleLengthMismatchError('[number, number[]]', [0, 1, 2], [0, 1]));
        });
    });
    // lazy
    ...
    describe('Decoder<a>', function () {
        describe('fold', function () {
            it('should take the onErr() route when the decoder fails', function () {
                var numberToStringWithDefault = json_decoder_1.JsonDecoder.number.fold(function (value) { return value.toString(16); }, function (error) { return '0'; }, false);
                expect(numberToStringWithDefault).to.equal('0');
            });
            it('should take the onOk() route when the decoder succeeds', function () {
                var stringToNumber = json_decoder_1.JsonDecoder.string.fold(function (value) { return parseInt(value, 10); }, function (error) { return 0; }, '000000000001');
        ...
        describe('decodeToPromise', function () {
            it('should resolve when decoding succeeds', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = expect;
                            return [4 /*yield*/, json_decoder_1.JsonDecoder.string.decodeToPromise('hola')];
                        case 1:
            ...
            it('should reject when decoding fails', function () {
                json_decoder_1.JsonDecoder.string.decodeToPromise(2).catch(function (error) {
        ...
        describe('chain', function () {
            ...
            it('should chain age decoder', function () {
                var adultDecoder = json_decoder_1.JsonDecoder.number.chain(function (age) {
                    return age >= 18
                        ? json_decoder_1.JsonDecoder.succeed
                        : json_decoder_1.JsonDecoder.fail("Age " + age + " is less than 18");
                });
        ...
        describe('mapError', function () {
            var numberWithMapErrorToNull = json_decoder_1.JsonDecoder.number.mapError(function () { return null; });
            var numberWithMapErrorToErrorMessage = json_decoder_1.JsonDecoder.number.mapError(function (error) { return error; });
    ...
    describe('FromDecoder<D>', function () {
        ...
        it('should infer object', function () {
            var userDecoder = json_decoder_1.JsonDecoder.object({
                name: json_decoder_1.JsonDecoder.string,
                age: json_decoder_1.JsonDecoder.number
            }, 'User');
            var myUser = {
                name: 'John Doe',
                age: 44
