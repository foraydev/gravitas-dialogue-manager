...
export declare type FromDecoder<Decoder> = Decoder extends JsonDecoder.Decoder<infer T> ? T : never;
export declare namespace JsonDecoder {
     ...
     */
    export const emptyObject: Decoder<{}>;
    /**
     ...
     */
    export function enumeration<e>(enumObj: object, decoderName: string): Decoder<e>;
     ...
     */
    export function allOf<T extends Array<Decoder<unknown>>, R>(...decoders: [...T, Decoder<R>]): Decoder<R>;
    /**
    ...
    export const tuple: <T extends readonly [] | readonly Decoder<any>[]>(decoders: T, decoderName: string) => Decoder<TupleOfResults<T>>;
    /**
...
export declare namespace $JsonDecoderErrors {
    ...
    const enumValueError: (decoderName: string, invalidValue: any) => string;
    ...
    const tupleLengthMismatchError: (decoderName: string, jsonArray: readonly any[], decoders: readonly any[]) => string;
}
